...
public static class Constants
{
    ...
    public static readonly Dictionary<string, string> SwitchMappings = new(StringComparer.InvariantCultureIgnoreCase)
    {
        ...
        ["--http-address"] = "Http:ListenAddress",
        ["--http-port"] = "Http:Port",
        ["--http-key"] = "Http:ApiKey",
        ["--http-max-upload-bytes"] = "Http:MaxUploadBytes",
        ["--http-timeout-seconds"] = "Http:TimeoutSeconds",
        ["--references"] = "Http:ReferencesPath",
    };
